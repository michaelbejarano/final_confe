...
class InvoiceController extends Controller
{
    public function send(Request $request)
    {
        ...
        //Descomentar solo para el postman api

        //se descomenta para la api
         //$company = Company::where('user_id', auth()->id())
         //            ->where('ruc', $data['company']['ruc'])
         //           ->firstOrFail();
        //solo para pruebas
        // $company = Company::where('ruc', $data['company']['ruc'])->firstOrFail();
$companyQuery = Company::where('ruc', $data['company']['ruc']);
